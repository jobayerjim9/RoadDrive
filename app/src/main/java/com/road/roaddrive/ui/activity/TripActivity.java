...
public class TripActivity extends AppCompatActivity implements OnMapReadyCallback, MapboxMap.OnMapClickListener, PermissionsListener, NavigationListener {
    ...
    private void getRoute(Point origin, Point destination) {
        lastLocation.getLastLocation().addOnSuccessListener(this, new OnSuccessListener<Location>() {
            ...
            public void onSuccess(Location location) {
                ...
                NavigationRoute.builder(TripActivity.this)
...
//                                .build();
                                ...
                                NavigationLauncher.startNavigation(TripActivity.this,options1);
